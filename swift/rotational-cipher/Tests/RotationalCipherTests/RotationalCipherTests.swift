...
//  func testRotationOver26() {
//      let expected = "The quick brown fox jumps over the lazy dog."
//      XCTAssertEqual(expected, RotationalCipher.rotate("Gur dhvpx oebja sbk whzcf bire gur ynml qbt.", ROT: 39))
//  }
//
//  func testRotationNegativeNumber() {
//      let expected = "The quick brown fox jumps over the lazy dog."
//      XCTAssertEqual(expected, RotationalCipher.rotate("Gur dhvpx oebja sbk whzcf bire gur ynml qbt.", ROT: -13))
//  }
...
//            ("testRotationOver26", testRotationOver26),
//            ("testRotationNegativeNumber", testRotationNegativeNumber),
        ]
    }
}
