...
public class MatrixTest {
    @Rule public ExpectedException exceptRule = ExpectedException.none();
    ...
    @Test public void throwsWhenOutOfBoundsColumn() {
        final var matrixStr = "1 2 3\n3 4 5\n6 7 8";
        final var matrix = new Matrix(matrixStr);

        final var colIdx = matrix.height + 1;
        this.exceptRule.expect(IndexOutOfBoundsException.class);
        matrix.getColumn(colIdx);
    }

    @Test public void throwsWhenOutOfBoundsRow() {
        final var matrixStr = "1 2 3\n3 4 5\n6 7 8";
        final var matrix = new Matrix(matrixStr);

        final var rowIdx = matrix.length + 1;
        this.exceptRule.expect(IndexOutOfBoundsException.class);
